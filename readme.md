...
This project implements a **Digital Dual Mixer Time Difference (DDMTD)** phase measurement system using only the native resources of a **Xilinx 7-series FPGA**.
...
A fully synthesizable HDL-based DDMTD core was designed and experimentally validated in hardware. Using MMCM-based clock generation and dynamic phase shifting within the FPGA fabric, the system demonstrates sub-nanosecond phase measurement capability at 125 MHz without any external TDC or analog circuitry.
...
- Sampling clock: Generated by MMCM with slight frequency offset
...
\[
\Delta t = \frac{N}{f_{sampled}}
\]

where phase difference is converted into a slow-beat frequency domain for high-resolution measurement.
...
<p align="center">
  <img src="images/ddmtd_system_bd.png" width="900">
</p>
...
- 🔧 Source Build Guide: [src/README.md](src/README.md)
- 📊 Statistical Analysis: [stat/README.md](stat/README.md)
